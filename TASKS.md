...
- [x] USB storage (UHCI y EHCI ambos completos en `kernel/uhci.c`/`kernel/ehci.c`: deteccion, enumeracion, Bulk-Only Transport/SCSI y `block_device_t`, verificado montando FAT32 real via ambos. xHCI sigue pendiente — ver ROADMAP.md Etapa 3).
